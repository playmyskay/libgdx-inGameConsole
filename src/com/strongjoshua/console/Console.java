...
public interface Console {
	...
	/**
	 * Makes the console also log to the System when {@link Console#log(String)} is
	 * called.
	 *
	...
	/**
	 * Set position of the lower left corner of the console as a percent of screen
	 * size
	 *
	...
	/**
	 * Call this method if you changed the input processor while this console was
	 * active.
	 */
	...
	/**
	 * Prints all log entries to the given file. Log entries include logs in the
	 * code and commands made from within in the console while the program is
	 * running.<br>
	 * <p>
	 * <b>WARNING</b><br>
	 * The file that is sent to this function will be overwritten!
	 *
	 * @param file The relative path to the file to print to. This method uses
	 *             {@link Files#local(String)}.
	 */
	 ...
	 * The file that is sent to this function will be overwritten!
	 *
	 * @param fh The {@link FileHandle} that links to the file to be written to.
	 *           Note that <code>classpath</code> and <code>internal</code>
	...
	/**
	 * @param disabled True if the console should be disabled (unable to be shown or
	 *                 used). False otherwise.
	 */
	public void setDisabled(boolean disabled);

	/**
	 * Gets the console's display key. If the console is enabled, the console will
	 * be shown upon this key being pressed.<br>
	...
	/**
	 * Sets this console's {@link CommandExecutor}. Its methods are the methods that
	 * are referenced within the console. Can be set to null, but this will result
	 * in no commands being fired.
	 *
	 * @param commandManager The {@link CommandManager} to use.
	 */
	public void setCommandManager(CommandManager commandManager);

	/** @return Returns the {@link CommandManager} used. */
	...
	/**
	 * Resets the {@link InputProcessor} to the one that was the default before this
	 * console object was created.
	 */
	public void dispose();
	...
	/**
	 * Hides or shows the console. Same effect as pushing the display button, except
	 * it doesn't toggle.
	 *
	 ...
	 *
	 * @param enabled - if true, commands annotated with {@link HiddenCommand} can
	 *                be executed
	 */
	 ...
	 * Sets the executeHiddenCommands field
	 *
	 * @param enabled - if true, commands annotated with {@link HiddenCommand} show
	 *                when printCommands (help) is executed
	 */
	...
	/**
	 * @param enabled If the command execution stack traces should be printed to the
	 *                console.
	 */
	...
	/**
	 * @param converter Adds a LogConverter implementation to manipulate log
	 *                  messages
	 */
